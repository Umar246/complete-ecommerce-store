...
const createOrder = async (user, shippAddress) => {
  try {
    ...
    const normalizedAddress = {
      firstName: shippAddress.firstName.trim().toLowerCase(),
      lastName: shippAddress.lastName.trim().toLowerCase(),
...
const findOrderById = async (orderId) => {
  // console.log('orderId in findOrderById', orderId)
  ...
  const order = await Orders.findById(orderId)
    ...
    // console.log('order in find order by id', order)
